...
const Members = () => {
  ...
  // Liste des ONG membres (basée sur les documents fournis)
  const members = [
    'AADECOM', 'AADI', 'AAFDRK', 'AAKLMFE', 'ACD', 'AEPPDGJR (HONNEY)', 'ACESEM', 'ADAIV', 'ADCOPS',
    'ADD MALI', 'ADDF-MALI', 'ADENORD', 'ADICOM', 'ADIL-MALI', 'ADT', 'AFAD', 'AFDP', 'AFEM',
    'AID-ZL', 'AJA-MALI', 'AJDM', 'RED', 'AMADE-PELCODE', 'AMALED', 'AMAPROS', 'AMCFE', 'AMSODE',
    'AMSS', 'APEP', 'APHALOG', 'APIF', 'A.PRO.F.E.J', 'APROFID', 'APSM', 'APSN', 'ARDIL',
    'ARDS', 'ASDAP', 'ASDEMIN', 'ASG', 'ASPODLCE', 'ASREF', 'ASSADDEC', 'ASSAHSSAL', 'ASSOPROFEN',
    'AVENIR', 'AVS', 'AZHAR', 'CAEB', 'CARD', 'CASE SAHEL', 'CERCA', 'CRADI', 'DDRNAS',
    'EFES N\'TAMADRITE', 'EFFAD', 'ENDA-MALI', 'ERADD', 'FEDE', 'FORJEC', 'GARDEL', 'GRADECOM',
    'GREFFA', 'GROUPE GOURMA', 'HELP-SAHEL', 'IMADEL', 'OMAES', 'OMPIDES', 'OPEN-MALI', 'PADI',
    'PIEAPCD', 'RAC', 'STOP-SAHEL', 'TASSAGHT', 'THINK PEACE', 'TILALTE', 'WALE', 'Windila Konda (WK)',
    'WOIYO KONDEYE', 'YA-G-TU'
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Nous accueillons avec fierté ces nouvelles organisations qui renforcent notre capacité d'action
            </p>
          </div>
            ...
            {filteredMembers.map((member, index) => (
              <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 text-sm">{member}</h3>
                  </div>
                </div>
              </div>
            ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto">
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-600">Être une ONG nationale légalement reconnue</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Intervenir dans le domaine humanitaire</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Accepter les statuts et règlement intérieur</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Disposer d'un Accord Cadre valide</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">S'acquitter des frais d'adhésion et cotisations</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Respecter la charte des membres</span>
                  </div>
                </div>
              </div>
            </div>
