            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">Renforcer la coordination des interventions des ONG membres</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-gray-600">Mutualiser les expériences et les ressources</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-gray-600">Promouvoir l'approche « localisation »</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-gray-600">Engager des actions de plaidoyer</span>
                </li>
              </ul>
              <Link 
                to="/about" 
